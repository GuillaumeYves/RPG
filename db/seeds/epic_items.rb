...
def create_item(name, item_type, item_class, level_requirement, gold_price, rarity, stats = {}, image_path)
    ...
    begin
        ...
        create_item("Burning Hatred", "Head", "Plate", 100, 52500, "Epic", { health: 420, strength: 105, willpower: 105, dreadmight: 105, armor: 47, magic_resistance: 23 }, 'app/assets/images/epic_items/burninghatred.jpg')
        ...
        create_item("Footsteps of Wisdom", "Feet", "Cloth", 100, 52500, "Epic", { health: 105, intelligence: 315, armor: 21, magic_resistance: 21 }, 'app/assets/images/epic_items/footstepsofwisdom.jpg')
        ...
        create_item("Grasp of Condemned Kings", "Hands", "Plate", 100, 52500, "Epic", { health: 315, strength: 189, dreadmight: 126, armor: 42, magic_resistance: 21 }, 'app/assets/images/epic_items/graspofcondemnedkings.jpg')
