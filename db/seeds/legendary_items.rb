...
[
  ...
  },
  {
    ...
    gold_price: 86250,
    rarity: "Legendary",
    health: (1500 * (rand(0.8..1.0))).to_i,
    armor: (150 * (rand(0.8..1.0))).to_i,
    magic_resistance: (80 * (rand(0.8..1.0))).to_i,
    willpower: (500 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    gold_price: 57500,
    rarity: "Legendary",
    health: (1000 * (rand(0.8..1.0))).to_i,
    armor: (75 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    gold_price: 57500,
    rarity: "Legendary",
    min_spellpower: (228 * (rand(0.8..1.0))).to_i,
    max_spellpower: (380 * (rand(0.8..1.0))).to_i,
    intelligence: (403 * (rand(0.8..1.0))).to_i,
    luck: (97 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    rarity: "Legendary",
    min_attack: (152 * (rand(0.8..1.0))).to_i,
    max_attack: (190 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    armor: (75 * (rand(0.8..1.0))).to_i,
    magic_resistance: (30 * (rand(0.8..1.0))).to_i,
    dreadmight: (170 * (rand(0.8..1.0))).to_i,
    strength: (164 * (rand(0.8..1.0))).to_i,
    intelligence: (164 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    gold_price: 57500,
    rarity: "Legendary",
    min_necrosurge: (114 * (rand(0.8..1.0))).to_i,
    max_necrosurge: (190 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    armor: (75 * (rand(0.8..1.0))).to_i,
    magic_resistance: (75 * (rand(0.8..1.0))).to_i,
    strength: (200 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    gold_price: 57500,
    rarity: "Legendary",
    health: (600 * (rand(0.8..1.0))).to_i,
    armor: (30 * (rand(0.8..1.0))).to_i,
    magic_resistance: (75 * (rand(0.8..1.0))).to_i,
    luck: (100 * (rand(0.8..1.0))).to_i,
    agility: (100 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    critical_strike_damage: (1.00 * (rand(0.8..1.0))),
  ...
  },
  {
    ...
    rarity: "Legendary",
    health: (800 * (rand(0.8..1.0))).to_i,
    armor: (50 * (rand(0.8..1.0))).to_i,
    magic_resistance: (50 * (rand(0.8..1.0))).to_i,
    luck: (100 * (rand(0.8..1.0))).to_i,
    agility: (150 * (rand(0.8..1.0))).to_i,
    strength: (150 * (rand(0.8..1.0))).to_i,
  ...
  },
  {
    ...
    rarity: "Legendary",
    health: (1000 * (rand(0.8..1.0))).to_i,
    armor: (40 * (rand(0.8..1.0))).to_i,
    magic_resistance: (40 * (rand(0.8..1.0))).to_i,
    intelligence: (200 * (rand(0.8..1.0))).to_i,
