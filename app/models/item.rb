class Item < ApplicationRecord
    ...
    def upgraded_stats
        upgraded_stats = {
            ...
            all_attributes: self.upgraded_all_attributes,
            fire_resistance: self.upgraded_fire_resistance,
            cold_resistance: self.upgraded_cold_resistance,
            lightning_resistance: self.upgraded_lightning_resistance,
            poison_resistance: self.upgraded_poison_resistance,
            all_resistances: self.upgraded_all_resistances,
            critical_resistance: self.upgraded_critical_resistance,
            damage_reduction: self.upgraded_damage_reduction,
    ...
    def randomize_attributes
        ...
        "Hands_Cloth" => { critical_strike_chance: 2.5, critical_strike_damage: 0.25, health: 300, intelligence: 100, fire_resistance: 100, cold_resistance: 100, lightning_resistance: 100, poison_resistance: 100, all_resistances: 50 },
        ...
        "Head_Plate" => { health: 900, strength: 100, dreadmight: 100, fire_resistance: 100, cold_resistance: 100, lightning_resistance: 100, poison_resistance: 100, all_resistances: 50, critical_resistance: 100 },
        "Head_Leather" => { health: 700, agility: 100, fire_resistance: 100, cold_resistance: 100, lightning_resistance: 100, poison_resistance: 100, all_resistances: 50, critical_resistance: 100 },
        "Head_Cloth" => { health: 500, intelligence: 100, fire_resistance: 100, cold_resistance: 100, lightning_resistance: 100, poison_resistance: 100, all_resistances: 50, critical_resistance: 100 },
        "Feet_Plate" => { health: 600, strength: 100, dreadmight: 100, fire_resistance: 100, cold_resistance: 100, lightning_resistance: 100, poison_resistance: 100, all_resistances: 50, critical_resistance: 100 },
        "Feet_Leather" => { health: 400, agility: 100, fire_resistance: 100, cold_resistance: 100, lightning_resistance: 100, poison_resistance: 100, all_resistances: 50, critical_resistance: 100 },
        "Feet_Cloth" => { health: 200, intelligence: 100, fire_resistance: 100, cold_resistance: 100, lightning_resistance: 100, poison_resistance: 100, all_resistances: 50, critical_resistance: 100 },
        "Chest_Plate" => { health: 1500, strength: 100, dreadmight: 100, fire_resistance: 100, cold_resistance: 100, lightning_resistance: 100, poison_resistance: 100, all_resistances: 50, critical_resistance: 100 },
        ...
        while allocated_attributes.keys.length < num_attributes_to_assign
            ...
            break if available_attributes.empty?
                ...
                allocated_value = allocated_value.to_i unless [:critical_strike_chance, :critical_strike_damage, :damage_reduction].include?(attribute)
    ...
    def update_item_name
        prefixes = {
            ...
            agility: "Agile",
            intelligence: "Wise",
            all_attributes: "Omnipotent",
            fire_resistance: "Fire Resistant",
            cold_resistance: "Cold Resistant",
            lightning_resistance: "Lightning Resistant",
        ...
        suffixes = {
            ...
            all_attributes: "of Omnipotence",
            fire_resistance: "of Fire Resistance",
            cold_resistance: "of Cold Resistance",
            lightning_resistance: "of Lightning Resistance",
        ...
        epic_armor_names = [
            ...
            "Flameveil", "Azurecrest", "Stormward", "Earthshroud", "Firelizard's Gaze", "Skullreaper", "Nightfall",
            "Blizzardguard", "Grandguard", "Astreon's Gaze", "Lightsurge", "Bloodbane", "Earthbound", "Widowsilk",
            "Reaper's Embrace", "Deathclasp", "Executioner's Grasp", "Lycander's Touch", "Eagleeye", "Ondal's Eye",
            "Titan's Embrace", "Ghostshadow", "Demonclaw", "Blade of Sunlight", "Crescent Veil", "Doomtouch",
            "Famine's Grasp", "Hand of Divinity", "Mang Song's Sight", "Razor's Touch", "Blackbog's Embrace",
            "Stormbringer", "Widow's Embrace", "Bane's Grip", "Dragon's Clasp", "Gloomcloak", "Moonlight's Embrace",
            "Guardian's Touch", "Stonebreaker", "Hammer's Might", "Reaper's Hold", "Gravelock's Embrace", "Doomtouch",
            "Shadowhusk", "Graveskin", "Nightveil", "Hollowheart", "Darkmantle", "Voidshroud", "Sorrowhide",
            "Deathveil", "Plaguewrap", "Grimplate", "Soulcage", "Specterhide", "Necroguard", "Shadeweave", "Boneveil",
            "Tombplate", "Hellshroud", "Gorehide", "Blackwrap", "Dreadplate", "Skullveil", "Eclipseshroud",
            "Ghoulhide", "Wraithmail", "Doomplate", "Shadowplate", "Phantomshroud", "Deathshroud", "Cryptwrap",
            "Mournmail", "Ghastwrap", "Wormhide", "Sorrowplate", "Corpseguard", "Nightmail", "Spiritveil",
            "Charnelplate", "Hellveil", "Bloodshroud", "Rotguard", "Gloomveil", "Baneplate", "Gravemail",
            "Voidveil", "Abyssmail", "Soulveil", "Maliceguard", "Torturehide", "Bloodweave",
        ]
        epic_weapon_names = [
            "Doombringer","Death's Web","Stormlash","Windforce",
            "Gimmershred","Boneshade","Hellrack","Flamebellow","Buriza-Do Kyanon","Grandfather","Astreon's Iron Ward",
            "Lightsabre","Bloodmoon","Earth Shifter","Widowmaker","Azurewrath","The Reaper's Toll","Death Cleaver",
            "Executioner's Justice","Lycander's Aim","Eaglehorn","Ondal's Wisdom","Stormspire","Titan's Revenge",
            "Ghostflame","Demon Limb","Crescent Moon","Doombringer","Earthshaker","Famine","Hand of Blessed Light",
            "Mang Song's Lesson","Razor's Edge","Blackbog's Sharp","Firelizard's Talon","Stormbringer","Widowmaker",
            "Bane","Dragon Talon","Gloomhorn","Moonlight Song","Skull Reaper","Guardian's Edge","Stone Crusher",
            "Hammer's Blaze","Reaper's Touch","Gravelock's Might","Soulrender","Wraithblade","Grimreaper","Nightscythe",
            "Darkfang","Bloodreaver","Shadowstrike","Voidedge","Bonecleaver","Hellslayer","Deathspike","Plaguereaper",
            "Spectralblade","Abyssalaxe","Ghoulrazor","Dreadscythe","Graveblade","Eclipsereaver","Phantomcleaver",
            "Necrofang","Soulcleaver","Voidreaver","Hellblade","Sorrowedge","Tombfang","Wormrazor","Spiritblade",
            "Cryptedge","Gloomscythe","Charnelaxe","Baneedge","Grimfang","Malicereaver","Nightblade","Bloodfang",
            "Wraithspike","Darkreaver","Hellrazor","Soulblade","Deathfang","Ghastreaver","Shadowedge","Voidfang",
            "Doomspike","Spiritrazor","Torturefang","Eclipsescythe","Sorrowspike","Necroedge","Mourningblade"
        ]
        epic_shield_names = [
            "Doomguard","Deathward","Stormcrest","Windshield","Glimmershield","Boneward",
            "Hellgaze","Flameguard","Frostwall","Granddefender","Astreon's Defiance","Lightbearer","Bloodbane",
            "Earthguard","Widowmaker","Azurebane","Reaper's Bulwark","Deathclaw Aegis","Executioner's Resolve",
            "Lycander's Protectorate","Eagleeye","Ondal's Sanctuary","Stormbreaker","Titan's Bastion","Ghostward",
            "Demonhide Barrier","Blade Sentinel","Crescent Moon","Doombreaker","Earthbreaker","Famine's Barrier",
            "Hand of the Guardian","Mang Song's Defense","Razor's Edge","Blackbog's Shield","Firelizard's Embrace",
            "Stormbringer","Widow's Embrace","Banebearer","Dragon's Roar","Gloomwall","Moonshadow","Skullguard",
            "Guardian's Shield","Stonecrusher","Hammer's Might","Reaper's Guard","Gravelock's Deflector",
            "Doombringer","Nightfall","Shadowguard","Graveward","Nightbarrier","Hollowbulwark","Darkwall",
            "Voidshield","Sorrowward","Bloodguard","Deathbarrier","Plaguebulwark","Grimward","Soulwall",
            "Specterbarrier","Necroshield","Shadewall","Bonebarrier","Abyssguard","Tombwall",
            "Hellshield","Gorebarrier","Blackwall","Dreadguard","Skullbarrier","Eclipseguard",
            "Malicewall","Ghoulbarrier","Wraithshield","Doomguard","Shadowshield","Phantombarrier",
            "Deathguard","Cryptwall","Soulbarrier","Mourningguard","Ghastwall","Wormbarrier",
            "Sorrowguard","Corpsewall","Nightguard","Spiritbarrier","Tortureshield","Charnelwall",
            "Hellguard","Bloodshield","Rotbarrier","Gloomguard","Banewall","Graveguard","Voidbarrier"
        ]
        epic_jewelry_names = [
            "Shadowfang","Soulstone","Bloodmoon","Doomgrip","Runeheart","Darkstar","Hellfire","Skullbane",
            "Voidshard","Netherfire","Dreadshadow","Ebonheart","Abyssal Eye","Doomwhisper","Wraithcoil",
            "Chaosbane","Twilight Edge","Soulkeeper","Fateshadow","Voidgaze","Deathshroud","Nightfall",
            "Eldritch Veil","Bloodbane","Ghoulclaw","Bonechill","Shadowveil","Sorrowblade","Cryptfire",
            "Darkmoon","Hellforged","Spectral","Necrofury","Gravetouch","Wraithheart","Dreadstorm","Gloomshroud",
            "Shadowflame","Doomfury","Blazeclaw","Abyssal Warden","Voidlash","Bloodthorn","Soulreaper",
            "Phantomstrike","Cursedheart","Eclipseshard","Darkmantle","Hollowsoul","Deathgaze","Cryptborn",
            "Nightshadow","Grimfire","Doomshroud","Spectral Bind","Bonechill","Soulweaver","Graveclasp",
        ]
        new_name = self.name
        allocated_attributes = {
            health: self.health,
            ...
            critical_resistance: self.critical_resistance,
            all_resistances: self.all_resistances,
